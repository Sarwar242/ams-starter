            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="flex justify-between items-center mb-6">
                        <h1 class="text-2xl font-bold">Edit Partner / 取引先編集</h1>
                    ...
                    <form method="POST" action="{{ route('business-partners.update', $businessPartner) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                             <div>
                                ...
                                <input type="text" name="code" value="{{ old('code', $businessPartner->code) }}"
                            ...
                            <div>
                                ...
                                <input type="text" name="contact_person" value="{{ old('contact_person', $businessPartner->contact_person) }}"
                                       class="w-full border rounded px-4 py-2">
                            </div>

                            <div>
                                <label class="block text-sm font-medium mb-2">Phone / 電話</label>
                                <input type="text" name="phone" value="{{ old('phone', $businessPartner->phone) }}"
                            ...
                            <div>
                                ...
                                <input type="email" name="email" value="{{ old('email', $businessPartner->email) }}"
                                       class="w-full border rounded px-4 py-2">
                            </div>
